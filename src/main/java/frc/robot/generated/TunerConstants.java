...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Stator limit prevents wheel slip and limits torque output
                .withStatorCurrentLimit(Amps.of(80)) //120
                .withStatorCurrentLimitEnable(true)
                // Supply limit prevents brownouts - set below 40A breaker rating
                .withSupplyCurrentLimit(Amps.of(50)) //70
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.364013671875);
